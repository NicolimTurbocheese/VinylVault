...
11. This app's users are in Singapore, buying and selling in a market where an ordinary secondhand pressing with no special rarity typically resells for roughly S$15-40 (comparable to Carousell / Roxy Records / Hear Records street pricing), not international "collector" asking prices. If verified completed-sale data is sparse or ambiguous, err toward the LOWER, more conservative end of the plausible range rather than the higher end — do not round up or pad the estimate. Reserve values above S$100 for pressings with an actual rarity signal you can point to in marketNotes (first pressing, deleted/rare title, notable artist, special edition, verified low print run) — a record being old or well-known is not on its own justification for a high price.
